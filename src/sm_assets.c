...
static bool sm_getWideStr(size_t nc_len, const char *const nc, size_t dstlen,
	...
	// make sure we converted the number of chars in the narrow string plus a null
	// terminator
...
static bool sm_readFile(const char *const fname, size_t *const readbytes, size_t dstlen,
	...
	// NOLINTNEXTLINE: widening conversion from positive int to size_t doesn't matter
